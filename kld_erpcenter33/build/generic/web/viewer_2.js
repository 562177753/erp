...
function GetRequest() {
	...
	var Strs;
	var url_1 = decodeURI(location.search);
	var theRequest = new Object();
	if(url_1.indexOf("?") != -1) {
		var Str = url_1.substr(1);
		Strs = Str.split("&");
...
var DEFAULT_URL = 'http://'+location.host+'/kld_erpcenter_test/kld_enroll/'+req.pdf_path+'';
// var DEFAULT_URL = '../../../kld_enroll/test.pdf';
